    ...
    <div className='firstChild'> 
      <div className="home-parent">
        <div className=" home">
          ...
          <p>Are you ready to take your business to the next level with cutting-edge IT solutions? Look no further! At Abhay Shoshodia, we specialize in providing innovative IT services and solutions tailored to meet your unique needs.</p>
